...
import{Intervention, InterventionService} from '../intervention-component/intervention-service'
...
getAllInterventions() {
  this.interventionService.getAllInterventions().subscribe({
    next: (data) => {
      ...
      this.Inprogress();
        this.interventions = this.interventionsFiltred.filter(i => i.technicienId === this.technicienId);
...
addIntervention() {
 ...
 if (
  ...
  this.newIntervention.technicienId=1;
